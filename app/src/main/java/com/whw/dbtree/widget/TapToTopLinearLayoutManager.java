 ...
 * @date 2018/8/6 0006
 */
public class TapToTopLinearLayoutManager extends LinearLayoutManager{
    public TapToTopLinearLayoutManager(Context context) {
        super(context);
    }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
            ...
            public PointF computeScrollVectorForPosition(int targetPosition) {
                return  TapToTopLinearLayoutManager.this.computeScrollVectorForPosition(targetPosition);
            }
